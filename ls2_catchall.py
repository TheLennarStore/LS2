...
pgs = lookup('how_many_pr_document3785')
desc_1 = ''
desc_2 = ''
desc_3 = ''
desc_bind = ''
...
if(ink == '0/0'):
  ...
  if bleeds == 'yes':
    ...
    filter_list = str('quote')

  ##final conflict for paper
  paper_limit =[]
  ...
  if (size_L > 13.0 and size_R > 19.0) or (size_L > 19.0 and size_R > 13.0):
    ...
    filter_fin1 = 'none other'
    desc_1 = '> 13x19'
  else:
    allow_fin1 = str('size == ') + size + str(' or size == ') + alt_size
    filter_fin1 = 'none corner_staple saddle_stitch_staple comb_binding coil_bind fastback_binding round_corners other'
    desc_1 = '< 13x19'

  ##final conflict save for fin1
  fin1_limits.append(allow_fin1 + str(' allow ') + str(filter_fin1))
  ...
  if (size_L > 13.0 and size_R > 19.0) or (size_L > 19.0 and size_R > 13.0):
    ...
    filter_fin2 = 'none cut_in_half cut_to_blecore__fold2585'
    desc_2 = '> 13x19'
  else:
    allow_fin2 = str('size == ') + size + str(' or size == ') + alt_size
    filter_fin2 = ''
  ...
  fin2_limits.append(allow_fin2 + str(' allow ') + str(filter_fin2))
  ...
  if finishing_options_1 == 'none':
    ...
    filter_fin3 = 'none lamination laminationg_foamcore3197 laminationgatorboard3414 mounting_only other'
    desc_3 = 'fin1 == none'
  ...
  fin3_limits.append(allow_fin3 + str(' allow ') + str(filter_fin3))
  conflicts['finishing_options_3'] = fin3_limits  

  #######################
  #### BINDING LIMITS ####
  if finishing_options_1 == 'comb_binding' or finishing_options_1 == 'coil_bind' or finishing_options_1 == 'fastback_binding':
    allow_bind = str('finishing_options_1 == comb_binding or finishing_options_1 == coil_bind or finishing_options_1 == fastback_binding')
    filter_bind = str('none clear_coveblack_back2395 clear_covelear_cover2547 clear_cove_cardstock2988 printed_ca_cardstock3642')
    desc_bind = 'Report Bound'
  elif finishing_options_1 == 'none' or finishing_options_1 == 'corner_staple' or finishing_options_1 == 'saddle_stitch_staple' or finishing_options_1 == 'round_corners':
    allow_bind = str('finishing_options_1 == none or finishing_options_1 == corner_staple or finishing_options_1 == saddle_stitch_staple or finishing_options_1 == round_corners')
    filter_bind = ''
    desc_bind = 'No report bound'
  else:
    allow_bind = ''
    filter_bind = ''
    desc_bind = "error"
  ...
  bind_limit.append(allow_bind + str(' allow ') + str(filter_bind))
  conflicts['binding_covers'] = bind_limit

  #####################
  #### MISC LIMITS ####
  if finishing_options_3 == 'laminationg_foamcore3197' or finishing_options_3 == 'mounting_only' or finishing_options_3 == 'laminationgatorboard3414':
    allow_misc = str('finishing_options_3 == laminationg_foamcore3197 or finishing_options_3 == mounting_only or finishing_options_3 == laminationgatorboard3414')
  ...
  misc_limit.append(allow_misc + str(' allow ') + str(filter_misc))
  ...
  if (size_L > 13.0 and size_R > 19.0) or (size_L > 19.0 and size_R > 13.0):
    ...
    if pgs <= 4:
      allow_pack = str('size == ') + size + str(' or size == ') + alt_size
      filter_pack = 'none any_amount shrink_wraackages_252934 shrink_wraackages_502932 shrink_wraackages_752939 shrink_wraackages_1002976 shrink_wraackages_1252983 shrink_wraackages_1502981 shrink_wraackages_1752988 shrink_wraackages_2002977 shrink_wraackages_2252984 shrink_wraackages_2502982 shrink_wraackages_2752989 shrink_wraackages_3002978 shrink_wraackages_4002979 shrink_wraackages_5002980 other'
      desc_pack = "<= 13x19 & <= 4pgs"
    elif pgs <= 10:
      allow_pack = str('size == ') + size + str(' or size == ') + alt_size
      filter_pack = 'none any_amount shrink_wraackages_252934 shrink_wraackages_502932 shrink_wraackages_752939 shrink_wraackages_1002976 shrink_wraackages_1252983 shrink_wraackages_1502981 shrink_wraackages_1752988 shrink_wraackages_2002977 shrink_wraackages_2252984 shrink_wraackages_2502982 other'
      desc_pack = "<= 13x19 & <= 10pgs"
    elif pgs <= 20:
      allow_pack = str('size == ') + size + str(' or size == ') + alt_size
      filter_pack = 'none any_amount shrink_wraackages_252934 shrink_wraackages_502932 shrink_wraackages_752939 shrink_wraackages_1002976 shrink_wraackages_1252983 shrink_wraackages_1502981 other'
  ...
  pack_limit.append(allow_pack + str(' allow ') + str(filter_pack))
